...
if __name__ == '__main__':
    ...
    for e in range(episodes):
        ...
        traci.start(["sumo-gui", "-c", "Real_Test1.sumocfg", '--start'])
...
#            print(activeJunction)
#            print(inactiveJunction)
#            
            ...
            if (action == 1):
                ...
                for i in range(3):
                    ...
                    traci.trafficlight.setPhase('LJ1',trafficphase)
                    traci.simulationStep()
                trafficphase = trafficphase + 1
                if (trafficphase > 7):
                    trafficphase = 0
            ...
            if (action == 0):
                for i in range(5):
                    ...
                    reward2 = traci.edge.getLastStepHaltingNumber(
                                ...
                                inactiveJunction[1]) + traci.edge.getLastStepHaltingNumber(inactiveJunction[2])
