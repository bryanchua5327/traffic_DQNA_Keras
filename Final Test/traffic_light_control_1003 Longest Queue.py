...
if __name__ == '__main__':
    ...
    for e in range(episodes):
        ...
        while traci.simulation.getMinExpectedNumber() > 0 and stepz < 7000:
            ...
            waiting_timeLE1=traci.edge.getWaitingTime('LE1')
            waiting_timeLE2=traci.edge.getWaitingTime('LE2')
            waiting_timeLE3=traci.edge.getWaitingTime('LE3')
            waiting_timeLE4=traci.edge.getWaitingTime('LE4')
            travel_timeLE1=traci.edge.getTravelTime('LE1')
            travel_timeLE2=traci.edge.getTravelTime('LE2')
            travel_timeLE3=traci.edge.getTravelTime('LE3')
            travel_timeLE4=traci.edge.getTravelTime('LE4')
            QueueLengthLE1=getLastStepVehicleNumber('LE1')
            QueueLengthLE2=getLastStepVehicleNumber('LE2')
            QueueLengthLE3=getLastStepVehicleNumber('LE3')
            QueueLengthLE4=getLastStepVehicleNumber('LE4')
            
            print("LE1 :," + str(waiting_timeLE1) +',' + str(travel_timeLE1)+',' + str(travel_timeLE1)+
                  ",LE2 :," + str(waiting_timeLE2) +',' + str(travel_timeLE2)+',' + str(travel_timeLE1)+
                  ",LE3 :," + str(waiting_timeLE3) +',' + str(travel_timeLE3)+',' + str(travel_timeLE1)+
                  ",LE4 :," + str(waiting_timeLE4) +',' + str(travel_timeLE4)+',' + str(travel_timeLE1))
            log.write("LE1 :," + str(waiting_timeLE1) +',' + str(travel_timeLE1)+',' + str(travel_timeLE1)+
                  ",LE2 :," + str(waiting_timeLE2) +',' + str(travel_timeLE2)+',' + str(travel_timeLE1)+
                  ",LE3 :," + str(waiting_timeLE3) +',' + str(travel_timeLE3)+',' + str(travel_timeLE1)+
                  ",LE4 :," + str(waiting_timeLE4) +',' + str(travel_timeLE4)+',' + str(travel_timeLE1))
